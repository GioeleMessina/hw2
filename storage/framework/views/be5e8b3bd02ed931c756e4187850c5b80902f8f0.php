...
<form id="form" name='registrazione' method='post' action="<?php echo e(route('registrazione')); ?>">
    <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.login_signup', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hw2-main\resources\views/registrazione.blade.php ENDPATH**/ ?>